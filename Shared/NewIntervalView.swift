    ...
    var body: some View {
        VStack{
            ...
            List(inter , id: \.id){ item in
                ...
                HStack{
                    Button {
                        info.NewintervalName = item.inters
                        dismiss()
                    } label: {
                        if info.NewintervalName == item.inters {
...
struct NewIntervalView_Previews: PreviewProvider {
    static var previews: some View {
        NewIntervalView(cheak: Color(#colorLiteral(red: 0.45328882336616516, green: 0.9041666388511658, blue: 0.24111109972000122, alpha: 1)))
